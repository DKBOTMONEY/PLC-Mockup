...
export function Dialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
      ...
      <div
        className={cn(
          "relative z-10 w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-2xl transition-all animate-in zoom-in-95",
          maxWidthClass
        )}
        role="dialog"
        aria-modal="true"
